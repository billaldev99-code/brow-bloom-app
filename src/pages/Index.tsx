...
import { getReviews, getPrestations, getGalleryItems, getMe, logout as apiLogout, setToken } from "@/integrations/api";
        ...
        <div className="container grid md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-4">
              ...
              <a href="https://www.instagram.com/Blooming_by_Kat/" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition-colors block">
                <Info icon={Instagram} label="@bloomingbykat" />
              </a>
              <a href="https://www.tiktok.com/@perfect.nails47" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition-colors block">
                <div className="flex items-center gap-3">
